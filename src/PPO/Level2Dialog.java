...
public class Level2Dialog extends JDialog {
    public Level2Dialog(JFrame owner) {
        super(owner, "New Level", true);

        // Create the button with the text "Move to level 2"
        JButton okButton = new JButton("Move to level 2");
        ...
        JTextArea text = new JTextArea("Congrats! You have accomplished level 1. Now the missiles will be 2x faster!");
